...
ifeq ($(strip $(DOCKER_CACHE_REGISTRY)),)
	DOCKER_CACHE_REGISTRY_PATH=localhost:5001/
else
	DOCKER_CACHE_REGISTRY_PATH=$(DOCKER_CACHE_REGISTRY)/
endif

SYSTEM_TEST_STAGE_IMAGE=$(DOCKER_CACHE_REGISTRY_PATH)stellar/system-test:dev
QUICKSTART_STAGE_IMAGE=$(DOCKER_CACHE_REGISTRY_PATH)stellar/system-test-base:dev
CORE_STAGE_IMAGE=$(DOCKER_CACHE_REGISTRY_PATH)stellar/system-test-core:dev
HORIZON_STAGE_IMAGE=$(DOCKER_CACHE_REGISTRY_PATH)stellar/system-test-horizon:dev
FRIENDBOT_STAGE_IMAGE=$(DOCKER_CACHE_REGISTRY_PATH)stellar/system-test-friendbot:dev
SOROBAN_RPC_STAGE_IMAGE=$(DOCKER_CACHE_REGISTRY_PATH)stellar/system-test-soroban-rpc:dev
